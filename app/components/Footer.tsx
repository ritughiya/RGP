...
export default function Footer(props : any) {
  return (
<>
     <div className="text-smmm lg:text-smm text-opacity-80 pt-md lg:pt-xxxll lg:mb-xxxll mb-xxxlll text-left lg:text-center font-sans text-sm tracking-[0.7px] w-full flex flex-col justify-center footerdesc">
