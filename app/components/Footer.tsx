...
<>
     <div className="text-smmm lg:text-smm text-opacity-80 pt-md lg:pt-xxxll lg:mb-xxxll mb-xxxlll text-left lg:text-center font-sans text-sm tracking-[0.8px] w-full flex flex-col justify-center footerdesc">
               ...
               Digital design & build, UX/UI interaction design, AI workflow integration, Web applications, Headless CMS, Headless e-commerce, Front & back-end development, Experimental development, Version control, Creative strategy, Digital concepts
              </span>
              <span className="mb-md">
